...
#define PNVL_HW_BAR0_DMA_CFG_MOD 0x20
#define PNVL_HW_BAR0_DMA_CFG_LEN_AVAIL 0x28
#define PNVL_HW_BAR0_DMA_DOORBELL_RING 0x30
#define PNVL_HW_BAR0_RETURN 0x38
...
#define PNVL_HW_BAR0_DMA_HANDLES_CNT (131072+1)
